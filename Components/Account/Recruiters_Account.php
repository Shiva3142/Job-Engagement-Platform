...
<main>
    ...
    <div class="AccountDataContainer">
        ...
        $sql = "SELECT * FROM `hiring_admins` WHERE `id` = '" . $_SESSION['Id'] . "'";
...
<div class="details">
    ...
    <h1 class="color-blue text-align-center">'.$row['company_name'].'</h1>
</div>
...
';
    ...
    <section class="jobPosts" style="background:white">
        ...
        <?php
        $search_sql = "SELECT * FROM applications as a, jobs as b where a.job_id=b.job_id and b.admin_Id='" . $_SESSION['Id'] . "' and a.status='hired';";
